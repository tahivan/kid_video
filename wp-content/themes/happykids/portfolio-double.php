				...
				<?php
					if ( has_post_thumbnail()) {
						...
						<div class="border-shadow alignleft">
							<figure>
								<a data-rel="prettyPhoto" class="prettyPhoto" title="<?php the_title(); ?>" href="<?php echo esc_url($image[0]); ?>"><img class="pic" src="<?php echo bfi_thumb( $image[0], array('width' => 354, 'height' => 253, 'crop' => true) ); ?>" alt="" /></a>
							</figure>
						</div><!--/ post-thumb-->
				<?php
					}
