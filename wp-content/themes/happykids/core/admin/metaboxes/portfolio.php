<?php
$config = array(
	'title' => __('Portfolio Options', 'creaws_admin'),
	'id' => 'cws_portfolio',
...
$options = array(
	...
	array(
		"name" => __("Portfolio button link", 'creaws_admin'),
		"desc" => "",
		"id" => "_port_butt_link",
		"default" => "",
		"type" => "text"
	...
	array(
		"name" => __("Item popup content (optional)", 'creaws_admin'),
		"desc" => "Pictures, videos etc",
		"id" => "_port_popup_link",
		"default" => "",
		"type" => "textarea"
	),
