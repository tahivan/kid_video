<?php
	...
	$settings = array(
		'title' => __('Page Options', 'creaws_admin'),
		'id' => 'cws_page_general',
		'pages' => array('page'),
		'callback' => '',
		'context' => 'normal',
	...
	array("type" => "meta_group", "name" => ""),//page group
		...
		array("type" => "meta_sidebar"),//page properties definition
			...
			array(
				"name" => __("Page type", 'creaws_admin'),
				"desc" => "",
				"id" => "_pagetype_check",
				"type" => "select",
				"options" => array(
								"default" => "--- Select page type ---",
								"page" => __("Page", 'creaws_admin'),
								"blog" => __("Blog", 'creaws_admin'),
								"port" => __("Portfolio", 'creaws_admin'),
								"gall" => __("Gallery", 'creaws_admin'),
								"cform" => __("Contact Page", 'creaws_admin'),
							),
				"default" => "default",
			),
		...
		array("type" => "meta_content"),//definition options
			...
			array(
				"name" => __("Portfolio template", 'creaws_admin'),
				"desc" => "",
				"id" => "_port_templ",
				"type" => "select",
				"options" => array(
			...
			array(
				"name" => __("Portfolio Category", 'creaws_admin'),
				"desc" => "",
				"id" => "_port_cat",
			...
			array(
				"name" => __("Items per page", 'creaws_admin'),
				"desc" => "",
				"id" => "_port_ipp",
				"type" => "text",
				"default" => "",
			...
			array(
				"name" => __("Blog template", 'creaws_admin'),
				"desc" => "",
				"id" => "_blog_templ",
				"type" => "select",
				"options" => array(
			...
			array(
				"name" => __("Blog Category", 'creaws_admin'),
				"desc" => "",
				"id" => "_blog_cat",
			...
			array(
				"name" => __("Page template", 'creaws_admin'),
				"desc" => "",
				"id" => "_page_templ",
				"type" => "select",
				"options" => array(
			...
			array(
				"name" => __("Gallery template", 'creaws_admin'),
				"desc" => "",
				"id" => "_gall_templ",
				"type" => "select",
				"options" => array(
				...
				array(
					...
					"default" => '',
					"type" => "sidebar_name_select",
					"class" => "sub_page_templ _sidebar_double"
				),
				array(
					"name" => "Right sidebar",
					"desc" => "",
	...
	array("type" => "meta_group", "name" => __("Other options", 'creaws_admin')),// group

		array(
			"name" => __("Show Breadcrumbs", 'creaws_admin'),
			"desc" => "",
			"id" => "_breadcrumbs",
			"label" => "Label",
			"default" => "",
