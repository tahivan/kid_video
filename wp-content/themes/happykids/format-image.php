...
<div class="post-entry">
	...
	<div class="border-shadow">
		<figure>
			<a title="<?php the_title(); ?>" data-rel="prettyPhoto" class="prettyPhoto kids_picture" href="<?php echo esc_url($image[0]); ?>"><img class="pic" src="<?php echo bfi_thumb( $image[0], array('width' => 544, 'height' => 255, 'crop' => true) ); ?>" alt="" /></a>
		</figure>
	</div><!--/ post-thumb-->
